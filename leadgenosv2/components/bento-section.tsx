...
export function BentoSection() {
  const cards = [
    ...
    },
    {
      ...
      description: "Residential proxies + human-like behavior = zero detection. Unlimited scale, stealth mode.",
      Component: LeadScraperVisualizer,
    },
    {
      title: "Know What You're Spending",
      description: "Real-time cost tracking with budget alerts. AI credits, sending costs—all in one place.",
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            ...
            <p className="w-full max-w-[700px] text-center text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
              We handle prospecting to personalization. You handle closing deals.
            </p>
          </div>
        </div>
